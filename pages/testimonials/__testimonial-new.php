<div class="wrapper-1440 " id="wrapper-1440__testimonial-new">
	<section class="testimonial-new">
		...
		<div class="testimonial-new__wrapper">
			<div class="testimonial-new__image"></div>

			<div class="testimonial-new__content">
				<h3 class="testimonial-new__name"></h3>
				<p class="testimonial-new__meta">
					<span class="testimonial-new__job"></span>
					<span class="testimonial-new__age"></span>
				</p>
				<blockquote class="testimonial-new__quote"></blockquote>
			</div>
		</div>
	</section>
</div>